...
(function() {
      ...
      if (idx === 1) {
        adMarkup = '<div class="nm-ad-container max-w-5xl mx-auto my-6" data-ad-container="ad-slot-rail-mid-1">' +
          ...
          '<div id="ad-slot-rail-mid-1" class="nm-ad-slot nm-ad-leaderboard">' +
            '<a href="https://t.me/netflix4u_website" target="_blank" rel="noopener noreferrer" class="nm-ad-placeholder">' +
  ...
  if (reqForm) {
    reqForm.addEventListener('submit', function(e) {
      ...
      var tgUrl = 'https://t.me/netflix4u_website?text=' + encodeURIComponent(msg);
