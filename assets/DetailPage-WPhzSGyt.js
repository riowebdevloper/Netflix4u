import{j as e,m as C}from"./vendor-framer-BGQgIPyw.js";import{r as l,L as ae,f as re,c as le,N as M}from"./vendor-react-h5WnBHGl.js";import{r as q,s as O,t as B,u as ie,v as oe,V as ne,T as Y,q as ce,l as T,m as Q,n as X,j as Z,w as de,G as me,d as xe,p as he,P as pe,x as ee,y as ue,k as ge,D as fe,z as be,A as ve,o as we,S as je}from"./vendor-ui-BbvII91P.js";import{a as ye,n as Ne,o as ke,u as $e,f as Ee,p as Se,q as Ce,r as Te,s as _e}from"./index-CQL8lqua.js";import{M as Re}from"./MovieCard-DyC9jox1.js";const Le="",Ie=s=>s==="series"||s==="anime"||s==="kdrama";function ze({id:s,canonicalId:cIdProp,imdbId:i,tmdbId:tmdb,type:a,title:n,poster:d,backdrop:x,links:Y_links}){
  ...
  l.useEffect(()=>{
    ...
    fetch(`/api/playback/${encodeURIComponent(cId)}?season=${o}&episode=${r}`)
  ...
  return e.jsxs("section",{id:"player",className:`scroll-mt-24 transition-all duration-300 ${p?"fixed inset-0 z-[90] bg-black flex flex-col":""}`,children:[
    ...
    e.jsx("div",{ref:z,className:`bg-black rounded-2xl overflow-hidden shadow-2xl border border-white/5 relative ${p?"flex-1 rounded-none border-0":""}`,children:e.jsxs("div",{className:`relative w-full ${p?"h-full":"aspect-video"}`,children:[
      ...
      currentUrl&&e.jsx("iframe",{ref:S,src:currentUrl,title:`Watch ${n}`,allowFullScreen:!0,allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture",className:"w-full h-full border-0",onLoad:()=>N(!1)})
    ]})}),
...
function Pe({content:s}){
  ...
  l.useEffect(()=>{
    ...
    return()=>{a=false;};
  },[s.id,s.poster,s.backdrop,s.title,s.imdbId,s.type]);

  return e.jsxs("div",{className:"relative min-h-[80vh] flex items-end",children:[
    ...
    e.jsx("div",{className:"relative z-10 max-w-[1600px] mx-auto px-4 lg:px-8 py-16 w-full",children:e.jsxs("div",{className:"flex flex-col md:flex-row gap-6 sm:gap-8 items-start md:items-end",children:[
      ...
      e.jsxs(C.div,{initial:{opacity:0,x:-20},animate:{opacity:1,x:0},transition:{duration:.5,delay:.1},className:"flex-1",children:[
        ...
        e.jsxs("div",{className:"flex flex-wrap items-center gap-3 sm:gap-4 mb-5",children:[
        ...
        e.jsx("div",{className:"flex flex-wrap gap-2 mb-5",children:(Array.isArray(s.genres)?s.genres:(Array.isArray(s.categories)?s.categories:[])).map(r=>e.jsx(ae,{to:`/genres?genre=${encodeURIComponent(r)}`,className:"btn-pill",children:r},r))}),
        s.seasons&&e.jsxs("div",{className:"flex items-center gap-4 mb-5 text-gray-400 text-sm",children:[e.jsxs("span",{children:[s.seasons," Season",s.seasons>1?"s":""]}),s.episodes&&e.jsxs("span",{children:[s.episodes," Episodes"]}),s.status&&e.jsx("span",{className:`px-2 py-0.5 rounded-full text-xs font-medium ${s.status==="Ongoing"?"bg-green-500/20 text-green-400":"bg-gray-500/20 text-gray-400"}`,children:s.status}),(s.network||s.studio)&&e.jsxs("span",{className:"flex items-center gap-1",children:[e.jsx(he,{className:"w-3.5 h-3.5"}),s.network||s.studio]})]}),
        e.jsxs("p",{className:"text-gray-500 text-sm mb-4",children:[e.jsx("span",{className:"text-gray-300 font-medium",children:"Director: "}),s.director||"Director"]}),
        e.jsx("p",{className:"text-gray-300 leading-relaxed mb-8 max-w-2xl",children:s.description||s.overview||("Watch "+(s.title||"this title")+" on Netflix4U in high quality.")}),
